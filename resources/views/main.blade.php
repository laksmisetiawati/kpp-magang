        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="{{ url('cs') }}"> <i class="menu-icon fa fa-puzzle-piece"></i>Customer Services </a>
                    </li>
                    <li>
                        <a href="{{ url('pelapor') }}"> <i class="menu-icon fa fa-puzzle-piece"></i>Pelapor </a>
                    </li>
                    <li>
                        <a href="{{ url('barang') }}"> <i class="menu-icon fa fa-puzzle-piece"></i>Barang </a>
                    </li>
                    <li>
                        <a href="{{ url('keluhan') }}"> <i class="menu-icon fa fa-puzzle-piece"></i>Keluhan </a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
